...
theme.fg_focus                                  = "#4DD0E1"
theme.fg_urgent                                 = "#CC9393"
theme.bg_normal                                 = "#141C21"
theme.bg_focus                                  = "#3C4449"
theme.bg_urgent                                 = "#141C21"
theme.border_width                              = dpi(1)
theme.border_normal                             = "#3F3F3F"
theme.border_focus                              = "#3C4449"
theme.border_marked                             = "#CC9393"
theme.tasklist_bg_focus                         = "#141C21"
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            wibox.container.background(theme.volume.widget, theme.bg_focus),l_dl,
            -- arr
            -- tempicon,
            -- temp.widget,
            -- arrl_ld,
